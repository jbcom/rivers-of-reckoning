...
class GamePyxelEnhanced:
    ...
    def draw_quest_ui(self):
        ...
        # Quest objective
        pyxel.text(panel_x + 5, panel_y + 20, self.current_quest['objective'], self.colors['text'])
        
        # Quest reward
        pyxel.text(panel_x + 5, panel_y + 35, f"Reward: {self.current_quest['reward']} gold", self.colors['success'])
    ...
    def draw_gameover(self):
        ...
        pyxel.text(self.WINDOW_WIDTH//2 - 30, self.WINDOW_HEIGHT//2 - 30, "GAME OVER", self.colors['text'])
        
        # Show final stats
        pyxel.text(self.WINDOW_WIDTH//2 - 40, self.WINDOW_HEIGHT//2 - 10, f"Final Gold: {self.player.gold}", self.colors['ui'])
        pyxel.text(self.WINDOW_WIDTH//2 - 40, self.WINDOW_HEIGHT//2, f"Final Score: {self.player.score}", self.colors['ui'])
